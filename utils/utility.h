...
int bCat_higgs3_2Mat(int b1, int b2, int b3){ // A pair that contains relatively leading pT bJet is chosen as an answer.
    int out;
    if ( (b1>=1) && (b1==b2) ) out = 0;
    else if ( (b1>=1) && (b1==b3) ) out = 1;
    else if ( (b2>=1) && (b2==b3) ) out = 2;
    else out = 3; // Unmatchable

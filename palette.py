...
# Validation
indir_val = "/home/stiger97/github/tthh/260705/"
drawHistoSame_Val(indir_val, tree, "GenHiggs1_m", "H1-GenJet m_{bb} (GeV)", "Normalized Events", "GenHiggs1_m", 60, 0, 300, "skimmed", "S0", yscale=1.3)
drawHistoSame_Val(indir_val, tree, "GenHiggs2_m", "H2-GenJet m_{bb} (GeV)", "Normalized Events", "GenHiggs2_m", 60, 0, 300, "skimmed", "S0", yscale=1.3)
drawHistoSame_Val(indir_val, tree, "Matched_Higgs1_m", "H1-Gen-matched Reco m_{bb} (GeV)", "Normalized Events", "Matched_Higgs1_m", 60, 0, 300, "skimmed", "S0", yscale=1.3)
drawHistoSame_Val(indir_val, tree, "Matched_Higgs2_m", "H2-Gen-matched Reco m_{bb} (GeV)", "Normalized Events", "Matched_Higgs2_m", 60, 0, 300, "skimmed", "S0", yscale=1.3)

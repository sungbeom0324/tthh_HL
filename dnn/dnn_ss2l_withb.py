...
#                     I/O                         #
###################################################
indir = "./skimmed/"; PRE = "ss2l"
outdir = "./dnn_result/" + PRE + "_withb/"
...
df_2 = pd.concat([df_ttbb, df_ttbbbb], ignore_index=True)
df_3 = pd.concat([df_tttt], ignore_index=True) #.sample(n=30)
df_4 = pd.concat([df_tth], ignore_index=True)
...
plot_confusion_matrix(y_val, pred_val_arg, classes=process_names, normalize=True, cmap=plt.cm.Reds, 
...
shap.summary_plot(shap_values, x_train, plot_type='bar', max_display=50, feature_names=input_dnn, show=False)

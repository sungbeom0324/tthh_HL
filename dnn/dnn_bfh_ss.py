...
#                     I/O                         #
###################################################
indir = "./skimmed/"; PRE = "b_ss" # Should be apart from data for event classification.
outdir = "./dnn_result/bfh_ss/"
os.makedirs(outdir, exist_ok=True)
class_names = ["Label 1", "Label 2", "Label 3", "Label 4", "Label 5", "Label 6", "Label 7", "Label 8", "Label 9", "Label 10", "Label 11"]
...
input_cat = ["jCat_higgs5_2Mat", "bCat_higgs5_2Mat_1", "bCat_higgs5_2Mat_2", "isMatchable"] # MODIFY #
...
df_cat1 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 0]
df_cat2 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 1]
df_cat3 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 2]
df_cat4 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 3]
df_cat5 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 4]
df_cat6 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 5]
df_cat7 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 6]
df_cat8 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 7]
df_cat9 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 8]
df_cat10 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 9]
df_cat11 = df_tthh.loc[df_tthh["jCat_higgs5_2Mat"] == 10]
...
#y_total = np.array(df_total.filter(items = ["jCat_higgs5_2Mat"]))
...
df_val['jCat_higgs5_2Mat'] = np.array(y_val.T[0])
...
shap.summary_plot(shap_values, x_train, plot_type='bar', max_display=50, feature_names=input_dnn+input_3_ss, show=False)
...
tree.Branch('jCat_higgs5_2Mat', bCat_higgs5_2Mat_array, 'jCat_higgs5_2Mat/F')
...
for _, row in df_val.iterrows():
    ...
    bCat_higgs5_2Mat_array[0] = row['jCat_higgs5_2Mat']

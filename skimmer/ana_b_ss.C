...
void  ana_b_ss(std::string channel, std::string outdir="../skimmed/"){
    ...
    auto infile = "/data2/sucho/HL-LHC/B_TRAIN/"+channel+"/merged/*.root"; // tthh_bbww_semi
    ...
    auto df4 = df3.Define("goodJet", "Jet.PT>=30 && abs(Jet.Eta)<3.0")
                  ...
                  .Define("MET_Eta", "MissingET.Eta[0]")
                  .Define("MET_Phi", "MissingET.Phi[0]")
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "b_ss_0804_" + channel + ".root", variables); 

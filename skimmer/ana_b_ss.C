...
// MODIFY!!
void ana_b_ss(std::string channel, std::string outdir="../skimmed/"){
    gSystem->Load("libDelphes");

    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA_new/parking_train/"+channel+"/b_train_ss/*.root";
...
//                  .Filter("nGenbQ == 4")  // CAUTION. THIS OPTION IS ONLY TTBB
    ...
    auto df4 = df3.Define("goodJet", "Jet.PT>=30 && abs(Jet.Eta)<3.0")
                  ...
                  .Define("Jet_btagLoose", "(Jet.BTag[goodJet] & (1 << 4)) != 0") // bit0 = DeepJet_Loose                  
                  ...
                  // jj_dr 
                  .Define("j1j2_dr", ::dR2, {"Jet1_pt", "Jet1_eta", "Jet1_phi", "Jet1_m", "Jet2_pt", "Jet2_eta", "Jet2_phi", "bJet2_m"})
                  .Define("j1j3_dr", ::dR2, {"Jet1_pt", "Jet1_eta", "Jet1_phi", "Jet1_m", "Jet3_pt", "Jet3_eta", "Jet3_phi", "bJet3_m"})
                  .Define("j1j4_dr", ::dR2, {"Jet1_pt", "Jet1_eta", "Jet1_phi", "Jet1_m", "Jet4_pt", "Jet4_eta", "Jet4_phi", "bJet4_m"})
                  .Define("j1j5_dr", ::dR2, {"Jet1_pt", "Jet1_eta", "Jet1_phi", "Jet1_m", "Jet5_pt", "Jet5_eta", "Jet5_phi", "bJet5_m"})
                  .Define("j2j3_dr", ::dR2, {"Jet2_pt", "Jet2_eta", "Jet2_phi", "Jet2_m", "Jet3_pt", "Jet3_eta", "Jet3_phi", "bJet3_m"})
                  .Define("j2j4_dr", ::dR2, {"Jet2_pt", "Jet2_eta", "Jet2_phi", "Jet2_m", "Jet4_pt", "Jet4_eta", "Jet4_phi", "bJet4_m"})
                  .Define("j2j5_dr", ::dR2, {"Jet2_pt", "Jet2_eta", "Jet2_phi", "Jet2_m", "Jet5_pt", "Jet5_eta", "Jet5_phi", "bJet5_m"})
                  .Define("j3j4_dr", ::dR2, {"Jet3_pt", "Jet3_eta", "Jet3_phi", "Jet3_m", "Jet4_pt", "Jet4_eta", "Jet4_phi", "bJet4_m"})
                  .Define("j3j5_dr", ::dR2, {"Jet3_pt", "Jet3_eta", "Jet3_phi", "Jet3_m", "Jet5_pt", "Jet5_eta", "Jet5_phi", "bJet5_m"})
                  .Define("j4j5_dr", ::dR2, {"Jet4_pt", "Jet4_eta", "Jet4_phi", "Jet4_m", "Jet5_pt", "Jet5_eta", "Jet5_phi", "bJet5_m"})
                  .Define("jj_dr", ::ConcatFloat_withoutSort_10, {"j1j2_dr", "j1j3_dr", "j1j4_dr", "j1j5_dr", "j2j3_dr", "j2j4_dr", "j2j5_dr", "j3j4_dr", "j3j5_dr", "j4j5_dr"})
                  // bb_dr 
                  ...
                  // Jet origin //
                  .Define("JetFrom", ::bJetFrom, {"Jet_pt", "b1JetFromHiggs1_pt", "b2JetFromHiggs1_pt", "b1JetFromHiggs2_pt", "b2JetFromHiggs2_pt", "bJetFromTop1_pt", "bJetFromTop2_pt"})
                  .Define("j1", "JetFrom[0]")
                  .Define("j2", "JetFrom[1]")
                  .Define("j3", "JetFrom[2]")
                  .Define("j4", "JetFrom[3]")
                  ...
                  .Define("jCat_higgs5_2Mat", ::bCat_higgs5_2Mat, {"j1", "j2", "j3", "j4", "j5"})
                  .Define("bCat_higgs3_2Mat", ::bCat_higgs3_2Mat, {"b1", "b2", "b3"})
    ...
    "jCat_higgs5_2Mat", "JetFrom", "j1", "j2", "j3", "j4", "j5",

    "nGenbQ",
    "GenbJet_pt_scheme", "bJetFrom",
    "b1", "b2", "b3", "b4", "b5", "nMatched_bFromTop", "nMatched_bFromHiggs", "nMatched_bJet",
    "bCat_higgs3_2Mat", "bCat_higgs5_2Mat", "bCat_higgs5_2Mat_1", "bCat_higgs5_2Mat_2", "bCat_top_1",
    //----------------Reco---------------------//
    // Lepton
    ...
    "j1j2_dr", "j1j3_dr", "j1j4_dr", "j1j5_dr", "j2j3_dr", "j2j4_dr", "j2j5_dr", "j3j4_dr", "j3j5_dr", "j4j5_dr",
    ...
    "Matched_idx1_Higgs1", "Matched_idx2_Higgs1", "Correct_Chi_Higgs1", "Chi_min_Higgs1",
    "Matched_idx1_Higgs2", "Matched_idx2_Higgs2", "Correct_Chi_Higgs2", "Chi_min_Higgs2",
    "Final_Chi2",
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "b_ss_" + channel + ".root", variables); 

...
void ana_b_ss(std::string channel, std::string outdir="../skimmed/"){
    ...
    auto infile = "/data2/sucho/HL-LHC/B_TRAIN/"+channel+"/merged/TTHH_SL_M_merged_1.root"; // tthh_bbww_semi
    ...
    auto df3 = df2.Define("b1JetFromHiggs1_pt", ::idx_var, {"Jet.PT", "bj1fh1"})
                  ...
                  .Define("GenJet_Jet_dR", ::Closest_dR, {"GenJet.PT", "GenJet.Eta", "GenJet.Phi", "GenJet.Mass", "Jet.PT", "Jet.Eta", "Jet.Phi", "Jet.Mass"});
...
*/
    ...
    "bCat_higgs4_2Mat", "bCat_higgs5_2Mat",
    "isMatchable",
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "b_ss_0725_" + channel + ".root", variables); 

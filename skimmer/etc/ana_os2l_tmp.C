...
// MODIFY!!
void ana_os2l_tmp(std::string channel, std::string outdir="../skimmed/"){
    gSystem->Load("libDelphes");

    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA_new/semi/"+channel+"/Events/*.root";
//    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA/di/"+channel+"/Events/train/tag_*.root"; // b //
...
//                  .Filter("nGenbQ == 4")  // CAUTION. THIS OPTION IS ONLY TTBB
    ...
    auto df5 = df4.Define("RecoHiggs", ::RecoHiggs, {"bJet_pt", "bJet_eta", "bJet_phi", "bJet_m", "b1JetFromHiggs1_pt", "b2JetFromHiggs1_pt", "b1JetFromHiggs2_pt", "b2JetFromHiggs2_pt"})
                ...
                .Define("Chi_min_Higgs2", "RecoHiggs[15]") // 두 번째 힉스의 Chi² 값
    ...
    // Final Chi2 value for both Higgses
    "Final_Chi2",
    ...
    // MODIFY!!
    df5.Snapshot(treename, outdir+ "semi_os2l_" + channel + ".root", variables); 

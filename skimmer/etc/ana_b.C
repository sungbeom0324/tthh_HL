...
// MODIFY!!
void ana_b(std::string channel, std::string outdir="../skimmed/"){
    gSystem->Load("libDelphes");

    auto infile = "/data1/users/stiger97/HLLHC_tthh/DATA_new/parking_train/"+channel+"/b_train/*.root";
    ...
    auto df0 = _df.Define("Lep1_m", "float(0)")
...
//                  .Filter("nGenbQ == 4")  // CAUTION. THIS OPTION IS ONLY TTBB
    ...
    auto df4 = df3.Define("goodJet", "Jet.PT>=30 && abs(Jet.Eta)<3.0")
                  ...
                  // Jet
                  .Define("Jet1_pt", "Jet_pt[0]").Define("Jet1_eta", "Jet_eta[0]").Define("Jet1_phi", "Jet_phi[0]").Define("Jet1_m", "bJet_m[0]")

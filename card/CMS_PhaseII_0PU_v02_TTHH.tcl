...
module PileUpMerger PileUpMerger {
  ...
  set PileUpFile /home/stiger97/programs/MG5_aMC_v2_9_14/Delphes/cards/CMS_PhaseII/MinBias_100k.pileup
...
module BTagging BTaggingDeepJetMedium {
  set JetInputArray JetEnergyScale/jets

#  set OutputArray btagTight_jets
  set BitNumber 1
...
module BTagging BTaggingMedium {
  set JetInputArray JetEnergyScale/jets
  set BitNumber 3
#  set OutputArray btagMedium_jets
...
module BTagging BTaggingLoose {
  set JetInputArray JetEnergyScale/jets
  set BitNumber 4
#  set OutputArray btagLoose_jets
